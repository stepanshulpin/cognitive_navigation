...
public class InfinityCourseTargetManager : MonoBehaviour {
    private void Start() {
        this.agentsManager = GetComponent<InfinityCourseAgentsManager>();
    ...
    private InfinityCourseAgentsManager agentsManager;
