...
public class Agent : MonoBehaviour {
    ...
    public void TargetPositionUpdated(Vector3 targetPosition) {
        Debug.Log("Target position updated " + targetPosition.ToString());
        this.targetPosition = targetPosition;
        this.hasTarget = true;
        this.navigationMesh.FindPath(this.transform.position, this.targetPosition);
    }
    ...
    private void initializeFuzzy() {
        ...
        LinguisticVariable speed = new LinguisticVariable("speed", 0.0, maxSpeed);
        speed.AddTerm(slow);
    ...
    private void Start() {
        ...
        this.navigationMesh = GameObject.FindGameObjectWithTag("Floor").GetComponent<NavigationMesh>();
    }
